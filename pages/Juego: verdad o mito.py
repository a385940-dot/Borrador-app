...
verdadero_o_falso = [
    {
        ...
        "respuesta": "Falso",
        "explicacion": "En muchas ciudades de México la calidad del agua de la red es monitoreada constantemente, mientras que el agua embotellada no siempre cumple todos los estándares y además genera muchísimo plástico."},
    {
        "afirmacion": "verdadero o falso: Lavar el coche con manguera gasta más de 300 litros de agua",
        "respuesta": "Verdadero",
        "explicacion": "Usar la manguera puede gastar hasta 500 litros. Usar una cubeta y esponja gasta solo unos 50 litros."},
    {
        "afirmacion": "verdadero o falso: Hervir el agua elimina los metales pesados (como el plomo).",
        "respuesta": "Falso",
        "explicacion": "Hervir el agua solo mata gérmenes (bacterias o virus). No elimina metales pesados, para eso se necesita un filtro."},
    {
        "afirmacion": "verdadero o falso: Se necesita más agua para producir 1kg de carne de res que 1kg de verduras",
        "respuesta": "Verdadero",
        "explicacion": "Se estima que producir 1kg de carne de res requiere unos 15,000 litros de agua (contando el riego del alimento para el animal), mientras que 1kg de maíz requiere unos 1,200 litros."}]
