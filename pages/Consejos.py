...
st.write("Cada gota cuenta, así que aquí tienes algunas acciones que puedes implementar en tu día a día para mejorar tu cuidado del agua")

with st.expander("Al bañarse"):
    st.write(
        """
        - **Reduce el tiempo en la regadera:** Intenta bañarte entre 5-10 minutos.
...
with st.expander("Para el cuidado del jardín"):
    st.write(
        ...
        """)
    st.image("https://www.gifss.com/profesiones/jardineros/jardinera.gif")
